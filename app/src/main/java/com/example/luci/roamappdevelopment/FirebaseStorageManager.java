...
public class FirebaseStorageManager
{
        ...
        riversRef.putFile(uri)
                ...
                .addOnProgressListener(new OnProgressListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onProgress(UploadTask.TaskSnapshot taskSnapshot) {
                        int n = (int)taskSnapshot.getTotalByteCount();
                        int actual = (int) taskSnapshot.getBytesTransferred();
    ...
    public void retrievePhotoFromCloud(Post holder, final CustomPostAdapter adapter) throws IOException
    {
